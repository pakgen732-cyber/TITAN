"""
Email Service for TITAN VENTURES Platform
...
class EmailService:
            ...
            <table width="100%" cellpadding="0" cellspacing="0" style="max-width: 600px; margin: 0 auto; background: linear-gradient(135deg, #1a1a2e 0%, #16213e 100%); border-radius: 16px; overflow: hidden;">
                <tr>
                    <td style="background: linear-gradient(90deg, #3b82f6, #8b5cf6); padding: 30px; text-align: center;">
                        <div style="font-size: 28px; font-weight: bold; color: white; letter-spacing: 2px;">TITAN VENTURES</div>
                        <div style="font-size: 12px; color: rgba(255,255,255,0.8); margin-top: 5px;">Digital Assets Community Platform</div>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    <td style="background: #0f0f1a; padding: 30px; text-align: center; color: #6b7280; font-size: 12px;">
                        <p style="margin: 0;">© 2026 TITAN VENTURES. All rights reserved.</p>
    ...
    async def send_verification_code(self, to_email: str, code: str, user_name: str = "User") -> bool:
        ...
        <p style="font-size: 16px; line-height: 1.6; color: #9ca3af;">Welcome to <span style="background: linear-gradient(90deg, #3b82f6, #8b5cf6); -webkit-background-clip: text; -webkit-text-fill-color: transparent; font-weight: bold;">TITAN VENTURES</span>! To complete your registration, please use the verification code below:</p>
        ...
        return await self.send_email(to_email, "TITAN VENTURES - Email Verification Code", html_content, "verification")
    ...
    async def send_password_reset(self, to_email: str, user_name: str, reset_code: str, reset_link: str) -> bool:
        ...
        return await self.send_email(to_email, "TITAN VENTURES - Password Reset Code", html_content, "password_reset")
    ...
    async def send_deposit_approved(self, to_email: str, user_name: str, amount: float) -> bool:
        ...
        return await self.send_email(to_email, "TITAN VENTURES - Deposit Approved", html_content, "deposit_approved")
    ...
    async def send_deposit_rejected(self, to_email: str, user_name: str, amount: float, reason: str) -> bool:
        ...
        return await self.send_email(to_email, "TITAN VENTURES - Deposit Status Update", html_content, "deposit_rejected")
    ...
    async def send_withdrawal_approved(self, to_email: str, user_name: str, amount: float, tx_hash: str) -> bool:
        ...
        return await self.send_email(to_email, "TITAN VENTURES - Withdrawal Processed", html_content, "withdrawal_approved")
    ...
    async def send_withdrawal_rejected(self, to_email: str, user_name: str, amount: float, reason: str) -> bool:
        ...
        return await self.send_email(to_email, "TITAN VENTURES - Withdrawal Status Update", html_content, "withdrawal_rejected")
    ...
    async def send_roi_notification(self, to_email: str, user_name: str, roi_amount: float, total_roi: float, package_name: str) -> bool:
        ...
        return await self.send_email(to_email, "TITAN VENTURES - Daily ROI Credited", html_content, "roi_notification")
    ...
    async def send_commission_notification(self, to_email: str, user_name: str, commission_amount: float, from_user: str, level: int, total_commission: float) -> bool:
        ...
        return await self.send_email(to_email, f"TITAN VENTURES - {level_name} Commission Earned", html_content, "commission_notification")
    ...
    async def send_level_promotion(self, to_email: str, user_name: str, old_level: int, new_level: int) -> bool:
        ...
        return await self.send_email(to_email, "TITAN VENTURES - Congratulations on Your Promotion!", html_content, "level_promotion")
    ...
    async def send_password_change_confirmation(self, to_email: str, user_name: str) -> bool:
        ...
        return await self.send_email(to_email, "TITAN VENTURES - Password Changed", html_content, "password_change")
    ...
    async def send_staking_completed_notification(self, to_email: str, user_name: str, capital_amount: float, total_earned: float) -> bool:
        ...
        return await self.send_email(to_email, "TITAN VENTURES - Staking Package Completed", html_content, "staking_completed")
